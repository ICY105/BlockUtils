...
#dynamic
execute if score #temp block_utils.data matches 0 positioned ~ ~01 ~ if block ~ ~ ~ #block_utils:v1.0/weak_power_top if predicate block_utils:v1.0/is_emitting_signal unless block ~ ~ ~ minecraft:redstone_torch run scoreboard players set #temp block_utils.data 1
execute if score #temp block_utils.data matches 0 positioned ~ ~-1 ~ if block ~ ~ ~ #block_utils:v1.0/weak_power_bottom if predicate block_utils:v1.0/is_emitting_signal run scoreboard players set #temp block_utils.data 1
execute if score #temp block_utils.data matches 0 positioned ~01 ~ ~ if block ~ ~ ~ #block_utils:v1.0/weak_power_side if predicate block_utils:v1.0/is_emitting_signal run scoreboard players set #temp block_utils.data 1
execute if score #temp block_utils.data matches 0 positioned ~-1 ~ ~ if block ~ ~ ~ #block_utils:v1.0/weak_power_side if predicate block_utils:v1.0/is_emitting_signal run scoreboard players set #temp block_utils.data 1
execute if score #temp block_utils.data matches 0 positioned ~ ~ ~01 if block ~ ~ ~ #block_utils:v1.0/weak_power_side if predicate block_utils:v1.0/is_emitting_signal run scoreboard players set #temp block_utils.data 1
execute if score #temp block_utils.data matches 0 positioned ~ ~ ~-1 if block ~ ~ ~ #block_utils:v1.0/weak_power_side if predicate block_utils:v1.0/is_emitting_signal run scoreboard players set #temp block_utils.data 1

#redstone torch
execute if block ~ ~1 ~ minecraft:redstone_wall_torch[lit=true] run scoreboard players set #temp block_utils.data 1
execute if block ~1 ~ ~ #block_utils:v1.0/redstone_torch[lit=true] run scoreboard players set #temp block_utils.data 1
execute if block ~-1 ~ ~ #block_utils:v1.0/redstone_torch[lit=true] run scoreboard players set #temp block_utils.data 1
execute if block ~ ~ ~1 #block_utils:v1.0/redstone_torch[lit=true] run scoreboard players set #temp block_utils.data 1
execute if block ~ ~ ~-1 #block_utils:v1.0/redstone_torch[lit=true] run scoreboard players set #temp block_utils.data 1
