...
execute if score #block_utils.major load.status matches 1 if score #block_utils.minor load.status matches ..0 run scoreboard players set #block_utils.minor load.status 0
